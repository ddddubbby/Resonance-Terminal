...
Resonance Terminal is a crypto-only narrative intelligence terminal, currently a private alpha built publicly toward milestone `v0.1.0-alpha.1`. The milestone loop, non-goals, and branch sequence are recorded in `docs/DESIGN.md`.
